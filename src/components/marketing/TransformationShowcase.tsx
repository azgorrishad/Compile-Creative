      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16">
        ...
        <div className="md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <motion.div
            ...
            className="flex flex-col gap-3"
          >
            <h4 className="font-display text-xs uppercase tracking-widest text-[var(--sage)] font-semibold">Strategic Move</h4>
          ...
          >
            <h4 className="font-display text-xs uppercase tracking-widest text-[var(--gold)] font-semibold">Outcome</h4>
